...
library(png)
library(grid)
img <- readPNG("C:/Users/Admin/Documents/R/WORKING_DIRECTORY/Meta-Analyse Buch/bookdown-demo-master/dummy.PNG")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("C:/Users/Admin/Documents/R/WORKING_DIRECTORY/Meta-Analyse Buch/bookdown-demo-master/metareg.PNG")
grid.raster(img)
```
