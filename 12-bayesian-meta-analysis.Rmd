...
* Bayesian methods allow us to directly model the **uncertainty** when estimating $\tau^2$, and have been found to be **superior in estimating the between-study heterogeneity and pooled effect**, particularly when the **number of included studies is small** (which is very often the case in real-world applications).
