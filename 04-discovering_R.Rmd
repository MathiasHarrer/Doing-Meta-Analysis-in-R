...
We have prepared an _Excel_ file for you called **"SuicidePrevention.xlsx"**, containing exactly this data. The file can be downloaded from the [Internet](http://protectlab.org/meta-analysis-in-r/data/SuicidePrevention.xlsx). 
