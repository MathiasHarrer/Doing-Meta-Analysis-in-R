...
Our `m.gen` object now contains all the meta-analysis results. An easy way to get an overview is to simply call the object directly in the _R_ console.
...
In the output, we see that the pooled 12-month prevalence of prescription opioid misuse in the selected studies is 9.4%, with the confidence interval ranging from 8.45 to 10.55%. 
